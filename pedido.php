			    ...
			    <div class="col-xs-12 col-md-6 col-md-offset-3" id="pedidohead">
				    <div class="row">
				    	...
				    	<div class="col-xs-2  col-sm-4 text-right">
					    	<? if($ptID && $total > 0){ ?>
					    	<a href="formulario-pedido_v3.php?tieID=<?= $tieID; ?>" class="btn btn-default" style="margin:0"><span class="hidden-xs"><? if($paisID==7){ ?>Adicionar<? }else{ ?>Agregar<? } ?> </span><i class="fa fa-plus-circle"></i></a>
							<? } ?>
				    	</div>
				    </div><!-- FIN ROW -->
			    </div>			    
				...
				<div class="col-xs-12 col-md-6 col-md-offset-3 posicion" >
					...
					<div class="row">
						<div class="col-lg-12 text-center">
					    	<br><br><a href="formulario-pedido_v3.php?tieID=<?= $tieID; ?>" class="btn btn-default btn-lg"><span><? if($paisID==7){ ?>Adicionar<? }else{ ?>Agregar<? } ?> </span><i class="fa fa-plus-circle"></i></a><br><br>
						</div>
					</div>
				</div>
			<?
