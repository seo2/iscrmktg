...
?>
    ...
    <div class="container" id="argumentos">
		...
		<header>
			    ...
			    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3" id="pedidohead">
			    	...
			    	<h2><small>Opciones: <strong><?= $pieza; ?></strong></small></h2>
				    	...
				    	<div class="col-xs-4 text-right">
					    	<? if($usuTipo==99){ ?>
					    	<a href="formulario-pieza-opciones_v3.php?insID=<?= $pieID; ?>&formID=<?= $formID; ?>" class="btn btn-default"><span class="hidden-xs">Agregar </span><i class="fa fa-plus-circle"></i></a>
					    	<? } ?>
				    	</div>
				    </div>
			    </div>
			...
			<?
				$sql  = "select * from instores_opciones_v3 where formID = $formID and insID = $pieID and insOPEst = 0 order by insOpNom";
				...
				<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 posicion">
					<div class="row">
						...
						<div class="col-xs-3 text-right posvotos">
							<a href="formulario-pieza-opciones_v3.php?formID=<?= $formID; ?>&insID=<?= $pieID; ?>&insOpID=<?= $r['insOpID']; ?>" class="btn btn-default">
							<? if($usuTipo==99){ ?>
